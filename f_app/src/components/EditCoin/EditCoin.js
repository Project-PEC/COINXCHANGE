...
function EditCoin(props) {
    ...
    const coin = props.location.param;

    const [file, setFile] = useState(null);
    const [preview, setPreview] = useState(null);
    const [image, setImage] = useState([...coin.image]);
