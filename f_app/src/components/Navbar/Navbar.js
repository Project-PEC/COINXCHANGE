        ...
        <div className='navbar-container'>
          ...
          {(button &&
            ...
            <Dropdown.Menu variant="dark" className="dropdownMenu">
              ...
              <Dropdown.Item><Button className="logoutButton" onClick={username ? logOut : faltu} link={username ? '/' : '/sign-up'} buttonStyle='btn--outline'>{username ? "LogOut" : "SIGN UP"}</Button></Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
            :
