...
const Services = (props) => {
    ...
    objectMap(show, function (c) {
        const carous = [];
        for (let i = 0; i < c.image.length; i++) {
            carous.push(
                <Carousel.Item>
                    <img
                        className="wid coin--img"
                        src={c.image[i]}
                        alt="First slide"
                    />
                </Carousel.Item>);
